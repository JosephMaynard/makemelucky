...
function ringShell(ctx: EffectContext, origin: THREE.Vector3, palette: number[], ringSpeed = 2.3, tilt = rand(-0.3, 0.3)) {
...
async function launchRocket(ctx: EffectContext, x: number, apexY: number, palette: number[], kind = 'peony') {
