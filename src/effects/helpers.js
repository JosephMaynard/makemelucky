...
import { tween } from '../core/anim.js';

/** Expanding additive ring shockwave. */
export function shockwave(scene, position, { color = 0xbfe8ff, maxScale = 4, duration = 700, z = 0.3 } = {}) {
...
export function dimLights(luckyScene, level = 0.3, duration = 600) {
...
export async function flashPulse(machine, peak = 1, upMs = 90, downMs = 500, color = 0xffffff) {
...
export function offscreenPoint(angle, radius = 4.6, z = 0.35) {
