...
export const ALL_CHARMS = [...PRESS_CHARMS, ...VISIT_CHARMS, ...STREAK_CHARMS, ...SPECIAL_CHARMS];
export const byTitle = new Map(ALL_CHARMS.map((c) => [c.title, c]));
export const byId = new Map(ALL_CHARMS.map((c) => [c.id, c]));
