...
export const QUIPS: Record<string, readonly [string, string]> = {
	...
	rainbow: ['ALL THE', 'WAY!'],
	cosmicDrift: ['WRITTEN IN', 'THE STARS'],
	...
	kpopLuck: ['LUCK IS ON', 'YOUR SIDE'],
	luckDragon: ['DRAGON:', 'SATISFIED'],
	slotArm: ['777.', 'HOUSE PAYS.'],
	solarEclipse: ['TOTALITY', 'ACHIEVED'],
	genieOfTheMachine: ['THE MACHINE', 'PROVIDES'],
	violetHour: ['THE HOUR', 'IS YOURS'],
	wishingWell: ['THE WELL', 'SAYS YES'],
	senbazuru: ['986 CRANES', 'TO GO'],
	badLuckGauntlet: ['NICE TRY,', 'SUPERSTITION'],
	manekiNeko: ['RAINBOWS:', 'DEPLOYED'],
	luckyTacos: ['EXTRA SPICY,', 'EXTRA LUCKY'],
	fairyKingdom: ['BY ROYAL', 'DECREE'],
	bhangraBaraat: ['BALLE', 'BALLE!']
};
